...
public partial class ApopnhstSql
{
    ...
    public string? Open1099VchrFg { get; set; }

    public string JnlCd { get; set; } = null!;

    public string JnlBatchId { get; set; } = null!;

    public int JnlDocNo { get; set; }
    ...
    public decimal? MiscChrgAmt { get; set; }
    ...
    public int? ApHstFechaRendicion { get; set; }

    public string? ApHstTipoReg { get; set; }

    public string? ApHstRetenFlg { get; set; }

    public string? ApHstCodAduana { get; set; }

    public decimal? ApHstPercTax { get; set; }

    public string? ApHstBaseImponi { get; set; }

    public string? ApHstDocImport { get; set; }

    public decimal? ApHstTcVenpub { get; set; }

    public string? ApHstNroPoliza { get; set; }

    public decimal? ApHstMontoFob { get; set; }

    public int? ApHstMontoFlt { get; set; }

    public decimal? ApHstMontoSgr { get; set; }

    public decimal? ApHstMontoAdv { get; set; }

    public decimal A4glidentity { get; set; }

    public decimal? NoAccountingEntry { get; set; }

    public string? CancelationProcessedFg { get; set; }

    public string? VoidAdLtFg { get; set; }

    public int? NoAccEntryReference { get; set; }

    public string? IsGeneratedByFfFg { get; set; }

    public string? IsGeneratedByReFg { get; set; }

    public int? DeferredGroup { get; set; }
    ...
    public string? CjaCd { get; set; }

    public string? LiquidationCd { get; set; }
    ...
    public string? VoidNcFg { get; set; }

    public string? ApHstTermCode { get; set; }
}
